...
for t in range(run_times):
    ...
    optimizer = LWOA(fitness=benchmark.Sphere,
    ...
    optimizer = LWOA(fitness=benchmark.Rastrigin,
    ...
    optimizer = LWOA(fitness=benchmark.Ackley,
    ...
    optimizer = LWOA(fitness=benchmark.Griewank,
    ...
    optimizer = LWOA(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = LWOA(fitness=benchmark.Rosenbrock,
    ...
    optimizer = LWOA(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = LWOA(fitness=benchmark.Quartic,
    ...
    optimizer = LWOA(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = LWOA(fitness=benchmark.Penalized1,
    ...
    optimizer = LWOA(fitness=benchmark.Penalized2,
    ...
    optimizer = LWOA(fitness=benchmark.Schwefel_226,
    ...
    optimizer = LWOA(fitness=benchmark.Step,
    ...
    optimizer = LWOA(fitness=benchmark.Kowalik,
    ...
    optimizer = LWOA(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = LWOA(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = LWOA(fitness=Shekel5,
    ...
    optimizer = LWOA(fitness=benchmark.Branin,
    ...
    optimizer = LWOA(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = LWOA(fitness=Shekel7,
                      D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = LWOA(fitness=benchmark.Shekel,
                      D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = LWOA(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = LWOA(fitness=benchmark.Hartmann6,
    ...
    optimizer = LWOA(fitness=benchmark.Zakharov,
    ...
    optimizer = LWOA(fitness=benchmark.SumSquares,
    ...
    optimizer = LWOA(fitness=benchmark.Alpine,
    ...
    optimizer = LWOA(fitness=benchmark.Michalewicz,
    ...
    optimizer = LWOA(fitness=benchmark.Exponential,
    ...
    optimizer = LWOA(fitness=benchmark.Schaffer,
    ...
    optimizer = LWOA(fitness=benchmark.BentCigar,
    ...
    optimizer = LWOA(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = LWOA(fitness=benchmark.Elliptic,
    ...
    optimizer = LWOA(fitness=benchmark.DropWave,
    ...
    optimizer = LWOA(fitness=benchmark.CosineMixture,
    ...
    optimizer = LWOA(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = LWOA(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(LWOA).csv')
